    ...
    html! {
        <>
            <header class={header_class}
                style="background-image:url('/static/header/SHAWN_2.webp');background-repeat:repeat;background-size:60px;">
                            ...
                            <div class="flex-1 md:flex-0 flex justify-center items-start z-50 -mt-1 -mb-4 sm:-mb-5 pl-3 pr-3">
                                <div class="relative w-40 sm:w-44 lg:w-52 h-20 sm:h-22 lg:h-26">
                                    ...
                                    <button onclick={navigate.reform(|_| Route::Home)}
                                        ...
                                        <img src="/static/header/KR_1.webp" alt="Home"
                ...
                <div class="absolute top-full left-0 right-0 overflow-hidden h-2.5 z-30"
                    style="background:url('/static/header/DIVIDER_2.webp') repeat-x top left; background-size:auto 100%;">
                </div>
            </header>
            ...
            >
                ...
                <div class="absolute bottom-0 left-0 right-0 overflow-hidden h-2.5 z-10"
                     style="background:url('/static/header/DIVIDER_2.webp') repeat-x top left; background-size:auto 100%; transform: translateY(100%);">
                </div>
            </div>
        </>
    }
