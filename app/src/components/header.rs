...
pub fn header(props: &HeaderProps) -> Html {
    ...
    let header_classes = if *is_visible {
        "fixed top-0 left-0 right-0 w-full z-40 transform -translate-y-0 transition-transform duration-500 ease-out bg-white shadow-lg border-b border-gray-200"
    } else {
        "fixed top-0 left-0 right-0 w-full z-40 transform -translate-y-full transition-transform duration-500 ease-out bg-white shadow-lg border-b border-gray-200"
    };
            ...
            <div class="container mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <nav class="hidden md:flex items-center space-x-8">
                        ...
                        <button
                            onclick={navigate.reform(|_| Route::Home)}
                            class="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 px-3 py-2 rounded-md hover:bg-gray-50"
                        >
                            {"Home"}
                        </button>
