    ...
    let projects = vec![
        Project {
            ...
            key_features: vec![
                ...
                "Image upload and processing".to_string(),
                "AI-powered skin lesion classification".to_string(),
                "User authentication and history tracking".to_string(),
                "Responsive web interface on both desktop and mobile".to_string(),
                "RESTful API".to_string(),
                "Continuous containerized deployment with Docker / Docker Compose".to_string(),
            ],
